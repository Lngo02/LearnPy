...
[↑ Integer arithmetic](Theory:-Integer-arithmetic)

1. [Basic operations](##Basic-operations)
2. [Writing complex expressions](##Writing-complex) 
3. [Other operations](##Other-operations)
4. [Operation priority](##Operation-priority)
5. [PEP time!](##PEP-time!)
...
Mathematicians and their publishers follow the opposite convention in order to solve the readability problem. Donald Knuth explains this in his ***Computers and Typesetting*** series: 
